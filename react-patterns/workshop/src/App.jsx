    ...
    <div className="grid grid-cols-12">
      ...
      <main className="col-span-9 py-6">
        <Routes>
          ...
          <Route path="/ssc/exercise" element={<UserCard title="My user card!" />} />
          {/* RP */}
          ...
          <Route path="/rp/exercise" element={<RPUserCard title="My user card!" />} />
          {/* Custom hooks */}
          ...
          <Route path="/ch/exercise" element={<CHUserCard title="My user card!" />} />
          {/* Compound Components */}
